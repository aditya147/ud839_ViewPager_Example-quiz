 ...
 */
public class MainActivity extends AppCompatActivity implements TuesdayFragment.SubjectFragmentCallback{
    ...
    public void addSubject(String name, String description) {
        Log.d("Aditya","callback in mainactivity" + name +description);
